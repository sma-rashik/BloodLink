    ...
    <div className="fixed inset-0 z-50 flex items-end justify-center bg-black/60 sm:items-center p-0 sm:p-4 animate-in fade-in duration-200">
      <div className="bg-white w-full max-w-md sm:rounded-3xl rounded-t-3xl shadow-2xl flex flex-col relative animate-in slide-in-from-bottom-full sm:slide-in-from-bottom-10 max-h-[90vh] transition-colors duration-200">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input 
                  ...
                  name="name" 
                  value={profile.name} 
                  onChange={handleChange} className="w-full pl-9 pr-4 py-2.5 bg-gray-50 border border-gray-200 text-gray-900 rounded-xl focus:ring-2 focus:ring-red-500 outline-none transition-all" 
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <select 
                  name="group" 
                  value={profile.group} 
                  onChange={handleChange} className="w-full pl-10 pr-10 py-2.5 bg-gray-50 border border-gray-200 text-gray-900 rounded-xl focus:ring-2 focus:ring-red-500 outline-none transition-all appearance-none" 
                >
            ...
            <div className="border-t border-gray-100 pt-4 mt-2">
              ...
              <div className="relative">
                ...
                <input 
                  ...
                  max={new Date().toISOString().split('T')[0]} // Max date is today className="w-full pl-9 pr-4 py-2.5 bg-gray-50 border border-gray-200 text-gray-900 rounded-xl focus:ring-2 focus:ring-red-500 outline-none transition-all" 
                />
              </div>
              {!isEligible && (
        ...
        <div className="p-6 border-t border-gray-100 bg-white sm:rounded-b-3xl">
          <button 
            onClick={handleSave} className="w-full bg-red-600 hover:bg-red-700 text-white font-bold py-3.5 rounded-xl shadow-md transition-colors flex items-center justify-center gap-2"
          >
